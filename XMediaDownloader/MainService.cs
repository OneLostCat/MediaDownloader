    ...
    IHostApplicationLifetime lifetime) : BackgroundService
{
    ...
    private void OutputArgumentsInfo()
    {
        ...
        logger.LogInformation("  下载类型: {DownloadType}", args.DownloadType.HasFlag(MediaType.All) ? "All" : args.DownloadType);
        ...
        logger.LogInformation("  存储目录: {StorageDir}", args.StorageDir);
